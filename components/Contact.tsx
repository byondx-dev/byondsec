          ...
          <div className="lg:col-span-3">
             <form className="space-y-6">
                ...
                <div className="space-y-2">
                    ...
                    <textarea className="w-full bg-secondary/50 border border-white/10 p-4 text-white focus:border-primary focus:outline-none focus:ring-1 focus:ring-primary/50 transition-all rounded-sm h-32" placeholder="Tell us about your tech stack and objectives..."></textarea>
                </div>
